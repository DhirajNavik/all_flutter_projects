...
import 'package:ivin_v_01/app/data/model/request/outside_vote_model.dart';
...
class PollingStationViewController extends GetxController {
  ...
  void setSelected(String value) {
    ...
    if (pollingStationCountResult != 0) {
      scrollController.jumpTo(0.0);
    }
    getPollingStationCount(selected.value);
    getPollingInsideData(selected.value);
  ...
  autoTrueCheckbox() {
    print(pollingStationResultList);
    ...
    checkBoxValueList = List.generate(pollingStationCountResult.value, (index) {
      ...
      var matchingResult = pollingStationResultList.firstWhere(
  ...
  Future<void> getPollingStationCount(String stationName) async {
    ...
    if (pollingStationCountResponse.data?.status == 200 ||
      ...
      pollingStationCountResult.value = result;
